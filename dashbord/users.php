      ...
      <div class="col-lg-10 col-md-6">
        <div class="left">
          <div class="mainTitle d-flex mb-5 align-items-center">
            <h2>المستخدمين</h2>
            <button class="btn btn-warning" onclick="showpoupup()"><i class="fa-solid fa-plus"></i> إضافة مستخدم</button>
          </div>
          ...
          <div class="poupupAdd" id="poupUp">
            <form action="" method="post" enctype="multipart/form-data">       
              ...
              <div>
                ...
                <input type="email" name="email" id="" placeholder="أدخل البريد الإلكتروني  " required>
              </div>
              <div>
                <p class=""><span>*</span> إسم المستخدم</p>
                <input type="text" name="username" id="" placeholder="أدخل  إسم المستخدم " required>
              </div>
              <div>
                <p class=""><span>*</span>كلمة المرور</p>
                <input type="text" name="password" id="" placeholder="أدخل كلمة المرور " required>
              </div>
              <div>
              ...
              <div>
                <button class="btn btn-warning" name="adduser" type="submit">إضافة</button>
              </div>
            </form>
          </div>
        </div>
