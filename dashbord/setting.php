    ...
    <nav class="navbar navbar-expand-lg ">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">
                <i class="fa-solid fa-house-signal"></i> اعدادات  الموقع</a>
                ...
                <div class="left">
                    <div class="row align-items-center">
                        <div class="col-lg-12 col-md-6">
                            <div class="rightcharts text-center">
                                <div class="mb-5">
                                    <div class="settings mt-3">
                                        <!-- <p>تعديل بياناتك الشخصية</p> -->
                                        <form action="" method="post" enctype="multipart/form-data" >
                                            <div>
                                              <p>تعديل شعار الموقع</p>
                                              <input type="file" name="logo" id="">
                                            </div>
                                            <div>
                                                <button class="btn btn-warning w-25" name="save_logo">حفظ التعديلات </button>
                                            </div>
                                        </form>
                                        <div class="taple">
                                            <?php showlogo($con) ?>
