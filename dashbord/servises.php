      ...
      <div class="col-lg-10 col-md-6">
        <div class="left">
          <div class="mainTitle d-flex mb-5 align-items-center">
            <h2>الخدمات</h2>
            <button class="btn btn-warning" onclick="showpoupup()"><i class="fa-solid fa-plus"></i>إضافة خدمة</button>
          </div>

          <div class="taple">
            <?php showAllservisess($con) ?>
          </div>
          <div class="poupupAdd" id="poupUp">
            <form action="" method="post" enctype="multipart/form-data">
              ...
              <div>
                ...
                <input type="file" name="imgser" id="" class="d-block">
              </div>
              <div>
                <p class=""><span>*</span> عنوان الخدمة</p>
                <input type="text" name="titleser" id="" placeholder="أدخل عنوان الخدمة" required>
              </div>
              <div>
                <p class=""><span>*</span>نص الخدمة</p>
                <textarea name="textserv" id="" ></textarea>
              </div>
              
              <div>
                <button class="btn btn-warning" name="addser" type="submit">نشر الخدمة</button>
              </div>
            </form>
          </div>
        </div>
